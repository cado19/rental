...
?>
  <div class="session">
    ...
    <form action="index.php?page=accounts/create" method="POST" class="log-in" autocomplete="off"> 
      ...
      <p>Welcome! Create an account to begin managing your fleet</p>
      ...
      <a href="https://codepen.io/elujambio/pen/yjwzGP" class="discrete" target="_blank">Have an account? Log in</a>
    </form>
  </div>
