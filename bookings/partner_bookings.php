...
$breadcrumb = "Bookings";
$breadcrumb_active = "Partner Bookings";
...
if (isset($_GET['id'])) {
	...
	$err_msg = "No such partner found";
	header("Location: index.php?page=bookings/partner_list&err_msg=$err_msg");
}
$bookings = partner_bookings($id);
