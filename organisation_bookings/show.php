<?php
    // THIS PAGE WILL SHOW AN ORGANISATION'S BOOKING'S DETAILS
    ...
    $breadcrumb        = "Bookings";
    $breadcrumb_active = "Organisation Booking";
    ...
    if (isset($_GET['id'])) {
        $id      = $_GET['id'];
        $booking = organisation_booking($id);
                ...
                <div class="card-body">
                    <div class="row">
                                  ...
                                  <div class="info-box bg-light">
                                    <div class="info-box-content">
                                      ...
                                      <span class="info-box-number text-center text-muted mb-0">
                                        <?php echo $booking['organisation_name']; ?>
                                      </span>
                                    </div>
                                  </div>
                                </div>
                        ...
                        <div class="col-12 col-md-12 col-lg-4 order-1 order-md-2">
                          ...
                          <p class="text-muted">This is the contract between The renter and <?php echo $booking['organisation_name']; ?>. The current state of the contract is<?php echo " "; ?><b><?php echo $booking['signature_status']; ?></b>.</p>
                          <br>
                          <div class="text-muted">
                            ...
                            <p class="text-sm">Client
                              <b class="d-block"><?php echo $booking['organisation_name']; ?></b>
                            </p>                            
                          ...
                          <div class="text-center mt-5 mb-3">
                            <?php if ($booking['signature_status'] == "unsigned"): ?>
                              <a href="index.php?page=organisation_bookings/edit_contract&id=<?php echo $id; ?>" class="btn btn-sm btn-primary">Sign Contract</a>
                            <?php endif;?>
                            <a href="index.php?page=organisation_bookings/show_contract&id=<?php echo $id; ?>" class="btn btn-sm btn-warning" target="_blank">Show contract</a>
