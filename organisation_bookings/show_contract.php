<?php
    ...
    $contract = organisation_contract($id);
...
<div class="container">
	...
	<div class="row">
		<div class="col">
			...
			<p><b>CUSTOMER NAME / HIRER:</b> <?php show_value($contract, 'o_name');?></p>
			<p><b>MOBILE NUMBER:</b> <?php show_value($contract, 'o_phone_no');?></p>
			<p><b>ADDRESS:</b> <?php show_value($contract, 'company_address');?></p>
			<p><b>COMPANY NO / PASSPORT:</b> <?php show_value($contract, 'company_no');?></p>
		</div>
	</div>
	...
	<div class="row">
			<table class="table">
				...
				<tr>
					...
					<td class="contract-td"><img src="organisation_bookings/signatures/<?php echo $contract['signature']; ?>" alt="Signature" class="signature-img"></td>
				</tr>
			</table>
	<div class="row">
		<p>
...
making or any nor for damage of goods for carriage charges or for carrying fare paying passengers.
		...
		<p>
			e. The hirer shall promptly, and teresly pay parking and traffic fines and if he fails to do so , he shall be responsible to pay the company additional
