...
// use the id from the url (lease_id) to fetch the contract id for the contract that needs to be signed
$sql = "SELECT id from lease_contracts WHERE lease_id = ?";
...
$link .= "?page=partners/lease/contract_edit&id=${id}";
    ...
    <div class="container">
            ...
            <div class="col-8 col-sm-12">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="partners/lease/contract_update.php" enctype="multipart/form-data">
                            <!-- pass the contract id as a hidden input field  -->
                            <input type="hidden" name="id" value="<?php echo $new_id; ?>">
                            <div id="signature-pad">
                                <div style="border:solid 1px teal;padding:3px;position:relative;">
                                ...
                                <div style="margin:10px;">
                                    ...
                                    <button type="submit" id="save_btn" class="btn btn-primary" data-action="save-png"><span class="glyphicon glyphicon-ok"></span> Save Signature</button>
                                </div>
                            </div>
                        <form>
        ...
        <div class="row d-flex justify-content-center align-items-center">
            <div class="col-8 col-sm-12 mt-3">
                <a href="index.php?page=partners/lease/contract_show&id=<?php echo $id; ?>" class="btn btn-success m-3" target="_blank">View contract</a>
                <a href="index.php?page=partners/lease/show&id=<?php echo $id; ?>" class="btn btn-warning">Back to Lease</a>
            </div>
